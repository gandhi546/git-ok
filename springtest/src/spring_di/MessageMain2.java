...
public class MessageMain2 {
	...
	public static void main(String[] args) {
		...
		Resource resource = new FileSystemResource("C:/web/jsp/sou/springtest/src/spring_di/applicationContext.xml");
		...
		Messageinter me = (Messageinter)factory.getBean("messageBean");
